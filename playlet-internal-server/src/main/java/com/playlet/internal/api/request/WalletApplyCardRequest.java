...
/**
 * 申请开卡入参（对齐 worldpay openCardApplyV2）。
 */
@Data
@ApiModel(value = "申请开卡", description = "选择卡产品后申请；需传持卡人；实体卡需邮寄地址；可选 KYC 快照")
public class WalletApplyCardRequest {

	@ApiModelProperty(value = "卡产品 id（来自 /card/product/list 的 productId）", required = true)
	...
	@ApiModelProperty(value = "三方邮寄地址 id，实体卡调三方开卡时传")
