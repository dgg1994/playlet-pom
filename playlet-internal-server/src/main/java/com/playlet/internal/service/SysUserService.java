...
public interface SysUserService {
	...
	ResponseBase signUp(@RequestParam("user") String user,@RequestPart(required = false) MultipartFile faceFile);
	...
	ResponseBase delUser(@PathVariable("userId") Integer userId);

    @PostMapping("/updateState")
	@Operation(summary = "改变用户账号状态", description = "改变用户账号状态")
    ResponseBase updateUserState(@RequestParam("userId") Integer userId, @RequestParam("newState") Integer newState);

    @PostMapping("/updateUser")
	@Operation(summary = "编辑用户信息", description = "编辑用户信息")
	ResponseBase updateUser(@RequestParam("user") String user,@RequestPart(required = false) MultipartFile file);

	@PostMapping("/resetPwd")
	@Operation(summary = "修改密码", description = "修改密码")
	ResponseBase resetPwd(@RequestParam("userId") Integer userId, @RequestParam("password") String password);

	@PostMapping("/resetUserPwd")
	@Operation(summary = "重置密码", description = "重置密码")
	ResponseBase resetUserPwd(@RequestParam("userId") Integer userId, @RequestParam("password") String password);

	@PostMapping("/verifyPwd")
	@Operation(summary = "校验账号密码", description = "校验账号密码")
	ResponseBase verifyPwd(@RequestParam("userId") Integer userId, @RequestParam("password") String password);
    ...
    ResponseBase upGoogleSecretkey(@RequestParam("userId") Integer userId, @RequestParam("googleSecretkey") String googleSecretkey);
	
	@GetMapping("/IssueGoogleSecretkey")
	@Operation(summary = "签发谷歌验证密钥", description = "签发谷歌验证密钥")
    ResponseBase IssueGoogleSecretkey(@RequestParam("userName") String userName);
