...
import com.playlet.oversea.api.response.WithdrawOrderAdminItemEntity;
import com.playlet.oversea.entity.welfare.UserWithdrawOrderEntity;
import com.playlet.oversea.query.welfare.WithdrawOrderAdminQuery;
...
public interface UserWithdrawOrderDao extends BaseMapper<UserWithdrawOrderEntity> {
	...
	@Select("<script>"
			...
			+ "wb.card_no as payAccount, o.asset_code as assetCode, o.gateway, o.network, "
			+ "o.status, o.setTime "
