...
import com.playlet.oversea.filter.GlobalRateLimitFilter;
import com.playlet.oversea.filter.JWTAuthenticationFilter;
import com.playlet.oversea.filter.JWTLoginFilter;
import com.playlet.oversea.handler.AuthenticationLogout;
import com.playlet.oversea.handler.TokenAccessDeniedHandler;
import com.playlet.oversea.handler.TokenAuthenticationEntryPoint;
import com.playlet.oversea.security.CustomAuthenticationProvider;
   ...
   private Boolean googleLimit;
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	http.cors().and().csrf().disable()
                ...
                .antMatchers("/sysNavigateConfig/find").permitAll()
