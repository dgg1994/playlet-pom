...
public interface UserFollowService {
	...
	ResponseBase followAdd(@RequestParam("followUid") Integer followUid, HttpServletRequest request);
	...
	ResponseBase followCancel(@RequestParam("followUid") Integer followUid, HttpServletRequest request);
