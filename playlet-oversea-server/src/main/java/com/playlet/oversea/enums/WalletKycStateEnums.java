...
public enum WalletKycStateEnums {
	 ...
	 */
	public static java.util.List<com.playlet.oversea.entity.system.DicEntity> getList() {
		java.util.List<com.playlet.oversea.entity.system.DicEntity> list = new java.util.ArrayList<>();
		for (WalletKycStateEnums item : values()) {
			com.playlet.oversea.entity.system.DicEntity dic = new com.playlet.oversea.entity.system.DicEntity();
			dic.setId(item.code);
